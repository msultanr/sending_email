...
$mail->setFrom('ari.fida@yahoo.com', 'Ari');           // Set sender of the mail

// include(".\api\get_data_email.php");

// foreach ($user_data as $user) {
//     $address = array($user->customer_email);
// }

// $address = array('arisukarno.2507@gmail.com', '18101041@ittelkom-pwt.ac.id', 'ari.fida@yahoo.com');
// $address = array('arisukarno.2507@gmail.com');
...
// $mail->addAddress('minahamdi02@gmail.com', 'mina');   // Name is optional
// $mail->addAddress($email_peserta);   // Name is optional
