...
// $mail->Username   = 'ari.fida@yahoo.com';    // SMTP username
// $mail->Password   = 'admin257';              // SMTP password
$mail->Username   = 'arisukarno.25@gmail.com';  // SMTP username
$mail->Password   = 'Ketutpandoyo.123';         // SMTP password
$mail->SMTPSecure = 'tls';                      // Enable TLS encryption, 'ssl' also accepted
$mail->Port       = 587;                        // TCP port to connect to

$mail->setFrom('arisukarno.25@gmail.com', 'Ari'); // Set sender of the mail

// include(".\api\get_data_email.php");

// foreach ($user_data as $user) {
//     $address = array($user->email);
// }

$address = array('arisukarno.2507@gmail.com', '18101041@ittelkom-pwt.ac.id', 'ari.fida@yahoo.com', 'arisukarno.25@outlook.co.id', 'minahamdi02@gmail.com', '18523189@students.uii.ac.id');
// $address = array('aphprisukarno.2507@gmail.com', '18101041@ittelkom-pwt.ac.id', 'ari.fida@yahoo.com', 'arisukarno.25@outlook.co.id');
